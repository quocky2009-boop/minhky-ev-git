...
export const TASK_STATUS = {
  ...
  failed:         { label: "Không đạt",      tone: "red",    short: "Không đạt" },
};

// Trạng thái coi như "đã đóng" — không tính quá hạn, không sửa được nữa
export const TASK_CLOSED = ["completed", "cancelled", "failed"];
...
export function hanLabel(due_at, status) {
  if (TASK_CLOSED.includes(status)) return null;
