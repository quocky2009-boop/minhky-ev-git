...
export function useCatalog() {
  ...
  const refresh = useCallback(async () => {
    const [{ data: v }, { data: l }, { data: i }, { data: b }, { data: st }, { data: cf }] = await Promise.all([
  ...
  return { supabase, vehicles, locations, brands, settings, taxRate, regions, customFields, inv, profile, loading, refresh, getQty, totalQty, regionQty };
}
