...
export const NAV_GROUPS = [
  ...
  { items: [
      { href: "/don-ban", label: "Bán hàng", icon: "₫", roles: ["CEO", "MANAGER", "SALES", "ADMIN"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/phu-tung", label: "Kho phụ tùng", icon: "⚙", roles: ["CEO", "MANAGER", "SALES", "ADMIN", "TECHNICIAN"] },
      { href: "/dich-vu-eod", label: "Đối soát cuối ngày", icon: "▣", roles: ["CEO", "MANAGER", "ADMIN"] },
    ],
  },
  {
    label: "QUẢN TRỊ", icon: "⚙",
    items: [
      { href: "/thu-chi", label: "Thu chi & Quỹ", icon: "💰", roles: ["CEO", "MANAGER", "ADMIN"] },
