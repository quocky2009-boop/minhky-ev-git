...
export const NAV_GROUPS = [
  { items: [{ href: "/dashboard", label: "Tổng quan", roles: ["CEO", "MANAGER", "ADMIN", "SALES", "TECHNICIAN"] }] },
  {
    ...
    items: [
      ...
      { href: "/cham-soc", label: "Chăm sóc khách hàng", roles: ["CEO", "MANAGER", "SALES", "ADMIN"] },
      { href: "/viec-cham-soc", label: "Việc chăm sóc", roles: ["CEO", "MANAGER", "SALES", "ADMIN"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/phu-tung", label: "Kho phụ tùng", roles: ["CEO", "MANAGER", "ADMIN", "TECHNICIAN"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/giai-ngan", label: "Giải ngân trả góp", roles: ["CEO", "MANAGER", "ADMIN"] },
  ...
  },
  {
    label: "MARKETING",
    items: [
      { href: "/marketing", label: "Việc marketing của tôi", roles: ["CEO", "MANAGER", "ADMIN", "SALES"] },
      { href: "/marketing/chien-dich", label: "Chiến dịch", roles: ["CEO", "MANAGER", "ADMIN"] },
      { href: "/marketing/duyet", label: "Duyệt báo cáo", roles: ["CEO", "ADMIN"] },
      { href: "/marketing/bao-cao-cty", label: "Báo cáo toàn công ty", roles: ["CEO", "ADMIN"] },
    ],
  },
  {
    label: "DANH MỤC",
